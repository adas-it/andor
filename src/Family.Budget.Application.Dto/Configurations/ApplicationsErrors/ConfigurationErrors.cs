namespace Family.Budget.Application.Dto.Configurations.Errors;
...
public sealed record ConfigurationErrorCodes : ErrorCode
{
    ...
    public static readonly ConfigurationErrorCodes NotificationValuesError = new(11_002);
    ...
    public static readonly ConfigurationErrorCodes Validation = new(11_0014);
}
...
public static class ConfigurationErrors
{
    ...
    public static ErrorModel ConfigurationValidation() => new(ConfigurationErrorCodes.Validation, "Configuration Validation.");
    public static ErrorModel ErrorOnSavingNewConfiguration() => new(ConfigurationErrorCodes.ErrorOnSavingNewConfiguration, "Unfortunately an error occorred when saving the Configuration.");
    ...
    public static ErrorModel OnlyDescriptionAreAvaliableToChangedOnClosedConfiguration() => new(ConfigurationErrorCodes.OnlyDescriptionAreAvailableToChangedOnClosedConfiguration, "Only description are avaliable to be changed on closed configuration.");
    ...
    public static ErrorModel TheMinimumDurationIsOneHour() => new(ConfigurationErrorCodes.TheMinimumDurationIsOneHour, "The minimun duration is one hour.");
