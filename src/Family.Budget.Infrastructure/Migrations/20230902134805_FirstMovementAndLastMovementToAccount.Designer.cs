...
namespace Family.Budget.Infrastructure.Migrations
{
    ...
    [Migration("20230902134805_FirstMovementAndLastMovementToAccount")]
    partial class FirstMovementAndLastMovementToAccount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Family.Budget.Domain.Entities.FinancialSummaries.FinancialSummary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FinancialSummary", "budget");
                });

            modelBuilder.Entity("Family.Budget.Domain.Entities.FinancialSummaries.SubCategoryWeek", b =>
                {
                    b.Property<Guid>("FinancialSummaryId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("Week5")
                        .HasColumnType("numeric");

                    b.HasKey("FinancialSummaryId", "SubCategoryId");

                    b.HasIndex("SubCategoryId");

                    b.ToTable("SubCategoryWeek", "budget");
                });
            ...
            modelBuilder.Entity("Family.Budget.Domain.Entities.FinancialSummaries.SubCategoryWeek", b =>
                {
                    b.HasOne("Family.Budget.Domain.Entities.FinancialSummaries.FinancialSummary", "FinancialSummary")
                        .WithMany("SubCategoriesWeek")
                        .HasForeignKey("FinancialSummaryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Family.Budget.Domain.Entities.FinancialSummaries.FinancialSummary", b =>
                {
                    b.Navigation("SubCategoriesWeek");
                });
