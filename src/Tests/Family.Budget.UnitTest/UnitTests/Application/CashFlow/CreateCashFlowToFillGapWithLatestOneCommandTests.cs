...
public class CreateCashFlowToFillGapWithLatestOneCommandTests
{
    private readonly CashFlowTestFixture _fixture;
    private readonly Mock<IUnitOfWork> _unitOfWorkMock;
    private readonly Mock<ICashFlowRepository> _cashFlowRepositoryMock;
    public CreateCashFlowToFillGapWithLatestOneCommandTests(CashFlowTestFixture fixture)
    {
        _fixture = fixture;
    ...
    public async Task ShouldInsertGap()
    {
        ...
        var item = new CreateCashFlowToFillGapWithLatestOneCommand()
        {
            Entity = GetChashFlow(
                2023,
                3,
        ...
        _cashFlowRepositoryMock.Setup(x => x.GetNextCashFlowByAccountIdAsync(accountId, 2023, 3, It.IsAny<CancellationToken>()))
        ...
        _cashFlowRepositoryMock.Verify(x => x.Insert(It.Is<cash.CashFlow>(c => c.AccountId == accountId && c.Year == 2023 && c.Month == 4), 
    ...
    public async Task ShouldInsertGapWithYearOfDifference()
    {
        ...
        _cashFlowRepositoryMock.Setup(x => x.GetNextCashFlowByAccountIdAsync(accountId, 2022, 11, It.IsAny<CancellationToken>()))
            .ReturnsAsync(GetChashFlow(
                2023,
                2,
                accountId,
    ...
    public async Task ShouldInsertGapWithYearsOfDifference()
    {
        ...
        _cashFlowRepositoryMock.Setup(x => x.GetNextCashFlowByAccountIdAsync(accountId, 2021, 11, It.IsAny<CancellationToken>()))
            .ReturnsAsync(GetChashFlow(
                2023,
                2,
                accountId,
    ...
    private CreateCashFlowToFillGapWithLatestOneCommandHandler GetApp()
    {
        return new CreateCashFlowToFillGapWithLatestOneCommandHandler(
